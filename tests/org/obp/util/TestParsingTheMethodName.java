...
public class TestParsingTheMethodName {
    ...
    public void testATMMethod(){
        assertEquals("getAtm",ParsingUtil.getScalaMethodName("override def getAtm(bankId: BankId, atmId: AtmId, callContext: Option[CallContext]): Future[Box[(AtmT, Option[CallContext])]] =\n" +
                "         {\n" +
